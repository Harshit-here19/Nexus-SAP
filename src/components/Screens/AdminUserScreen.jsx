    ...
    return (
      <div className="sap-panel">
        ...
        <div className="sap-panel-content">
          <div
            className="sap-message-strip error"
            style={{ marginBottom: "20px" }}
          >
            <span className="sap-message-strip-icon">🔒</span>
            <span>
              <strong>Access Denied!</strong> You do not have permission to
              access User Administration. This transaction is only available to
              users with <strong>Admin</strong> role.
            </span>
          </div>
          <div
            style={{
  ...
  return (
    <div>
      ...
      <div className="sap-panel">
        ...
        <div className="sap-panel-content">
          ...
          >
            ...
            <span>
              <strong>Security Notice:</strong> This screen displays sensitive
              information including passwords. Handle with care and do not share
              this information.
            </span>
          </div>
          ...
          >
            ...
            >
              ...
              <SapButton onClick={loadUsers} type="glass" icon="🔄">
                Refresh
              </SapButton>
            </div>
          </div>
          ...
          >
            <div>
              <span
                style={{ color: "var(--sap-text-secondary)", fontSize: "12px" }}
              >
                Total Users
              </span>
              <div
      ...
      <SapModal
        ...
        footer={
          <>
            <SapButton onClick={() => setShowCreateModal(false)} type="danger">
              Cancel
            </SapButton>
            <SapButton onClick={handleCreateUser} type="close">
              Create User
            </SapButton>
          </>
        }
      ...
      <SapModal
        ...
        footer={
          <>
            <SapButton onClick={() => setShowDeleteConfirm(false)} type="warning">
              Cancel
            </SapButton>
